...
namespace TestDemo
{
    ...
    {
        public const string RetrainConnectionString = @"Data Source=.;Initial Catalog=caipiaosouce;Integrated Security=True;Encrypt=False";
        public const string RetrainCommandString = @"SELECT CAST([QiShu] as REAL), CAST([AAA001] as REAL), CAST([AAA002] as REAL), CAST([AAA003] as REAL), CAST([AAA004] as REAL), CAST([AAA005] as REAL), CAST([AAA006] as REAL), CAST([AAE001] as REAL), CAST([Year] as REAL) FROM [dbo].[T_CaiPiao]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:59,seriesLength:316,trainSize:1519,horizon:10,outputColumnName:@"AAA001",inputColumnName:@"AAA001",confidenceLowerBoundColumn:@"AAA001_LB",confidenceUpperBoundColumn:@"AAA001_UB");
